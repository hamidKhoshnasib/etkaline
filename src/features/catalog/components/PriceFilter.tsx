  ...
  return (
    ...
    >
      ...
      >
        ...
        {open ? (
          <ChevronUpIcon className="text-primary border-primary size-5 rounded-full border p-0.5" />
        ) : (
          <ChevronDownIcon className="text-primary border-primary size-5 rounded-full border p-0.5" />
        )}
      </button>
